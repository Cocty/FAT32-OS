...
/* 取得num簇的下一簇 返回下一簇的内容 出错返回0*/
u32 getNext(FileSystemInfop fsip,u32 num);
/* 输入的文件名转换为8.3格式的文件名 若文件名合法则返回SUCCESS否则返回ERROR */
